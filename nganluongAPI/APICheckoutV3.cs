...
namespace GreenFood.nganluongAPI
{
    public class APICheckoutV3
    {
        ...
        private static String HttpPost(string postData)
        {
            ...
            // Prepare web request...
            HttpWebRequest myRequest = (HttpWebRequest)WebRequest.Create("https://sandbox.nganluong.vn:8088/nl35/checkout.api.nganluong.post.php"); //Create("https://www.nganluong.vn/checkout.api.nganluong.post.php"); //Create("https://sandbox.nganluong.vn:8088/nl35/checkout.api.nganluong.post.php");//
